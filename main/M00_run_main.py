...
# M00_run_main.py
# ----------------------------------------------------------------------------------------------------
# Universal entry point for the project.
#
# Purpose:
#   - Launches the project in GUI mode *if available*.
#   - Falls back to CLI or pipeline mode otherwise.
#   - Ensures logging, configuration, and core utilities are initialised.
#
# Usage:
#   python main/M00_run_main.py
# ----------------------------------------------------------------------------------------------------
